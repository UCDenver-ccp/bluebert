...
class CraftProcessor(BlueBERTProcessor):
    def get_labels(self):
        return [
            "bears_constitution_of_or_situatedness_at_or_possession_by_or_derivation_from",
            "coexists_as",
            "realizes_or_attribute_or_bearer_of_occurrence_in_or_possession_by",
            "realizes_or_bears_or_is_attribute_of_derivation_or_situatedness_or_possession_from",
            "false",
        ]
    
class Craft100Processor(BlueBERTProcessor):
    def get_labels(self):
        return [
            ...
            "has_attribute_of_variant_absence_or_lack_of_functionality",
            "coexists_as",
...
class BiolinkGeneToLocationProcessor(BlueBERTProcessor):
    def get_labels(self):
        return [
            "located_in",
            "other"
...
def main(_):
    ...
    processors = {
        ...
        "bl_gene_to_anatomy": BiolinkGeneToLocationProcessor,
        "bl_gene_to_cell_component": BiolinkGeneToLocationProcessor,
        "bl_gene_to_cell": BiolinkGeneToLocationProcessor,
        "bl_process_to_location": BiolinkProcessToLocationProcessor,
        "bl_process_to_anatomy": BiolinkProcessToLocationProcessor,
        "bl_process_to_cell_component": BiolinkProcessToLocationProcessor,
        "bl_process_to_cell": BiolinkProcessToLocationProcessor,
